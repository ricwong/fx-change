...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(FXChange.config.endpoints);

    var serviceConfig = $.extend(true, {}, FXChange.config.services, {
        db: {
    ...
    FXChange.db = new DevExpress.data.ODataContext(serviceConfig.db);
